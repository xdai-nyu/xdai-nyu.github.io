...
- [Pathways370: Hyperlocalized, community-centered (socially and expansively) audio walks](pathways)
- [ArtFlow: Art Portfolio Planner. An AI led web application that helps young artists to plan a portfolio.](nextframe)
- [JOBI: AI Companion/Coach + Embedded Learning in Lived Experiences for skill-building in context](feedbackFour)
